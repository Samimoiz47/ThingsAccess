...
<head>
    ...
    <title>Privacy Policy - ThingsAccess</title>
...
<body class="bg-black text-white min-h-screen">
    ...
    <main class="pt-32 pb-20 px-6 max-w-4xl mx-auto">
        ...
        <div class="prose prose-invert max-w-none text-gray-300">
            ...
            <p class="mb-4">At ThingsAccess, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.</p>

            <h2 class="text-2xl font-bold text-white mt-8 mb-4">2. The Data We Collect</h2>
            ...
            <h2 class="text-2xl font-bold text-white mt-8 mb-4">3. How We Use Your Data</h2>
            ...
            <h2 class="text-2xl font-bold text-white mt-8 mb-4">4. Data Security</h2>
            ...
            <p class="text-white">Email: privacy@thingsaccess.com</p>
            <p class="text-white">Address: 100 Innovation Drive, Suite 500, San Francisco, CA 94105</p>
        </div>
    </main>

    <footer class="py-12 border-t border-white/10 mt-12 bg-black">
