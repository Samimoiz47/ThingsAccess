...
<head>
    ...
    <title>NFC Industrial Tracking App for Real-Time Production Monitoring - ThingsAccess</title>
    ...
    <style>
        ...
        .case-study-hero {
            background: linear-gradient(135deg, rgba(147, 51, 234, 0.1) 0%, rgba(0, 0, 0, 0.8) 100%);
        }
        .skill-tag {
        ...
        <div class="max-w-7xl mx-auto">
            <div class="case-study-hero rounded-3xl p-12 md:p-16">
                <div class="flex items-center gap-4 mb-6">
                    <!-- <span class="px-4 py-2 bg-purple-500/20 text-purple-300 text-sm font-medium rounded-full">Mobile App</span>
                    <span class="text-gray-400">•</span> -->
                    <span class="text-gray-300">Published Dec 29, 2025</span>
                </div>
                <h1 class="text-4xl md:text-6xl font-bold mb-6">NFC Industrial Tracking System for Real-Time Production Monitoring</h1>
                <p class="text-xl text-gray-300 max-w-3xl">Developed Sentex, a high-performance Android mobile app for real-time monitoring of machines, operators, and production bundles using NFC. Operators can check-in/check-out, assign and track bundles, and receive instant alerts for delays or faults.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="sticky top-24 space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                A specialized industrial application utilizing NFC technology for precise production line tracking. Sentex bridges the physical and digital worlds, offering real-time visibility into machine operations and operator workflows.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-300 leading-relaxed space-y-2 text-base">
                                <li>NFC-enabled operator check-in/check-out for accurate shift tracking.</li>
                                <li>Real-time machine status monitoring and fault alerts.</li>
                                <li>Digital production bundle tracking and assignment.</li>
                                <li>Live managerial dashboards for productivity analysis.</li>
                                <li>Scalable Android architecture for industrial deployment.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                Sentex represents a significant leap in industrial digitization. The project involved developing a rugged Android application designed for the factory floor. By leveraging Near Field Communication (NFC), we automated the tracking of personnel and production units, eliminating manual data entry errors. The system provides managers with a live feed of production metrics, machine uptime, and operator performance. Integrated with a robust API backend, Sentex ensures that critical data is instantly available for decision-making, ultimately driving higher efficiency and reducing operational downtime.
                            </p>
                        </div>
                ...
                <div class="lg:col-span-1 order-1 lg:order-2">
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/03080dae-f140-4c7f-aadf-a4a1e95dc40d" alt="NFC Industrial Tracking App for Real-Time Production Monitoring" class="w-full h-auto">
                        </div>

                        <!-- Image 2 -->
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/50ac6c29-471c-4047-aaac-ac19ca0d68d8" alt="Operator Check-in/Check-out Interface" class="w-full h-auto">
                        </div>

                        <!-- Image 3 -->
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/052038e4-2163-4ea1-94d4-40ae59ebfae2" alt="Real-time Dashboard" class="w-full h-auto">
                        </div>
