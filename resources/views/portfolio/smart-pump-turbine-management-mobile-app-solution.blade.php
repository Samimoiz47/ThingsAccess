...
<head>
    ...
    <style>
        ...
        .case-study-hero {
            background: linear-gradient(135deg, rgba(20, 184, 166, 0.1) 0%, rgba(0, 0, 0, 0.8) 100%);
        }
        .skill-tag {
        ...
        <div class="max-w-7xl mx-auto">
            <div class="case-study-hero rounded-3xl p-12 md:p-16">
                <div class="flex items-center gap-4 mb-6">
                    <!-- <span class="px-4 py-2 bg-teal-500/20 text-teal-300 text-sm font-medium rounded-full">Mobile App</span>
                    <span class="text-gray-400">•</span> -->
                    <span class="text-gray-300">Published Dec 29, 2025</span>
                </div>
                <h1 class="text-4xl md:text-6xl font-bold mb-6">Smart Pump & Turbine Management System</h1>
                <p class="text-xl text-gray-300 max-w-3xl">Developed a high-performance mobile app for smart pump and turbine management, enabling real-time monitoring, control, and scheduling of multiple devices. Integrated MQTT for live updates and RESTful APIs for data management.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="sticky top-24 space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                An advanced mobile command center for the management of industrial pumps and turbines. This application offers unified control and monitoring capabilities, streamlining operations for complex fluid management systems.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-300 leading-relaxed space-y-2 text-base">
                                <li>Remote control (Start/Stop) and scheduling of pumps and turbines.</li>
                                <li>Live monitoring of flow rates, pressure, and power consumption.</li>
                                <li>Multi-device management from a single interface.</li>
                                <li>Automated scheduling and timer-based operations.</li>
                                <li>Comprehensive data logging for operational audits.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                The Smart Pump & Turbine Management System creates a digital twin of fluid management infrastructure. Designed for industrial utility managers, the mobile app provides granular control over geographically dispersed pumps and turbines. The solution leverages MQTT for instant command execution and real-time telemetry. Key functionalities include the ability to create complex operating schedules, view historical performance charts, and receive instant alarms for mechanical anomalies, ensuring optimal system performance and resource conservation.
                            </p>
                        </div>
                ...
                <div class="lg:col-span-1 order-1 lg:order-2">
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/ea422ac1-9d3f-4f61-b64b-0254b3613571" alt="Smart Pump & Turbine Management – Mobile App Solution" class="w-full h-auto">
                        </div>

                        <!-- Image 2 -->
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/e7669051-1e32-4e79-8737-06139190f9c2" alt="Pump and Turbine Monitoring Dashboard" class="w-full h-auto">
                        </div>
