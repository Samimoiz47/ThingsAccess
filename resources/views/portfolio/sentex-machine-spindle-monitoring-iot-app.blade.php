...
<head>
    ...
    <title>Sentex Machine & Spindle Monitoring IoT App - ThingsAccess</title>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="case-study-hero rounded-3xl p-12 md:p-16">
                <div class="flex items-center gap-4 mb-6">
                    <!-- <span class="px-4 py-2 bg-cyan-500/20 text-cyan-300 text-sm font-medium rounded-full">IoT Solution</span>
                    <span class="text-gray-400">•</span> -->
                    <span class="text-gray-300">Published Dec 29, 2025</span>
                </div>
                <h1 class="text-4xl md:text-6xl font-bold mb-6">Sentex Machine & Spindle Monitoring System</h1>
                <p class="text-xl text-gray-300 max-w-3xl">Developed a complete IoT solution for real-time machine monitoring. Integrated MQTT and REST APIs to track electrical load, RPM, temperature, spindle status, and historical performance graphs.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="sticky top-24 space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                A specialized IoT application dedicated to real-time machine spindle monitoring. Sentex provides critical insights into machine health, RPM, and temperature, enabling predictive maintenance and operational efficiency.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-300 leading-relaxed space-y-2 text-base">
                                <li>Real-time tracking of electrical load, RPM, and temperature.</li>
                                <li>Spindle status monitoring (On/Off/Idle).</li>
                                <li>Historical performance graphing and trending.</li>
                                <li>Anomaly detection and instant alert system.</li>
                                <li>Seamless hardware integration via MQTT using customized firmware.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                This project focused on the precision monitoring of industrial machine spindles. We developed a comprehensive IoT solution that captures high-frequency data from machine sensors, including electrical load, rotational speed (RPM), and thermal status. This data is transmitted via MQTT to a secure cloud backend and visualized in a custom mobile application. Managers can view live statuses of their entire fleet, helping to identify bottlenecks and predict mechanical failures before they result in costly downtime. The system also includes detailed reporting features for post-shift analysis.
                            </p>
                        </div>
                ...
                <div class="lg:col-span-1 order-1 lg:order-2">
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="project-image">
                            <img src="{{ asset('images/portfolio/Spindle monitoring/spindle 1.jpg') }}" alt="Spindle Monitoring System - Interface 1" class="w-full h-auto">
                        </div>

                        <!-- Image 2 -->
                        <div class="project-image">
                            <img src="{{ asset('images/portfolio/Spindle monitoring/spindle 2.jpg') }}" alt="Spindle Monitoring System - Interface 2" class="w-full h-auto">
                        </div>

                        <!-- Image 3 -->
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/fee79a50-2d14-4b82-9692-a95b6c9276cd" alt="Sentex Machine & Spindle Monitoring IoT App" class="w-full h-auto">
                        </div>

                        <!-- Image 4 -->
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/819b9885-037a-42de-b135-75755b36d8d6" alt="Machine Monitoring Dashboard" class="w-full h-auto">
                        </div>
