                    ...
                    <div class="sticky top-24 space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                An intelligent agricultural solution leveraging IoT for precision farming. This system utilizes advanced field sensors and automated water management to optimize crop yield and conserve resources.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-300 leading-relaxed space-y-2 text-base">
                                <li>Comprehensive environmental monitoring (Soil Moisture, Acidity, Temperature).</li>
                                <li>Automated irrigation via smart solenoid valves.</li>
                                <li>Data-driven pesticide usage optimization.</li>
                                <li>Long-range communication using LoRaWAN technology.</li>
                                <li>Mobile application for remote monitoring and manual override.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                The Smart Irrigation System is an end-to-end agritech solution designed to modernize farming practices. We deployed a network of robust field sensors to capture critical soil and environmental health data. This data feeds into a central processing unit that automates irrigation schedules through smart valves, ensuring crops receive the exact amount of water needed. Integrated with LoRaWAN for efficient long-distance communication in rural areas, and accessible via a mobile app, the system empowers farmers to reduce labor costs, minimize water wastage, and significantly enhance crop production.
                            </p>
                        </div>
                ...
                <div class="lg:col-span-1 order-1 lg:order-2">
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="project-image">
                            <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/0c198c4b-cce2-4c00-a466-13f9e78999db" alt="Smart Irrigation System" class="w-full h-auto">
                        </div>
