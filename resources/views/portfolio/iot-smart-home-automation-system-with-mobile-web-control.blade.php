...
<body class="bg-black text-white min-h-screen">
        ...
        <div class="max-w-7xl mx-auto">
            <div class="case-study-hero rounded-3xl p-12 md:p-16">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <span class="text-gray-300">Published Nov 28, 2025</span>
                </div>
                <h1 class="text-4xl md:text-6xl font-bold mb-6"> Smart Home Automation System </h1>
                <p class="text-xl text-gray-300 max-w-3xl">Things Access has designed and developed a complete smart home system, including hardware and firmware for smart switches, along with integration of commercial off-the-shelf smart devices through a central hub.</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="sticky top-24 space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                A complete smart home ecosystem designed by Things Access, bridging proprietary hardware with commercial smart devices. This comprehensive solution offers unified control, enhancing comfort and energy efficiency.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-300 leading-relaxed space-y-2 text-base">
                                <li>Custom-designed hardware and firmware for smart switches (1-gang to 5-gang).</li>
                                <li>Central hub for seamless integration of diverse smart devices.</li>
                                <li>Dual-mode operation: Remote (Cloud) and Local (Offline) control.</li>
                                <li>Voice control integration with Alexa.</li>
                                <li>Real-time and historical energy consumption analytics.</li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-300 leading-relaxed text-base">
                                This project encompassed the end-to-end development of a smart home automation system. We engineered custom PCBs and firmware for a range of smart switches, ensuring reliability and responsiveness. The core of the system is a central hub that unifies these custom devices with third-party off-the-shelf products, providing a single point of control. Users can manage their home environment via a sleek mobile application or voice commands through Alexa. Key features include robust offline functionality for uninterrupted control during internet outages and detailed energy monitoring profiles to help households optimize their power usage.
                            </p>
                        </div>
  ...
  <!-- Image 1 -->
                        <div class="project-image">
                             <img src="https://www.upwork.com/att/download/portfolio/persons/uid/1808407666023190528/profile/projects/files/cd5774ef-5fdc-4f3a-b25b-633336cf7c3a" alt="Smart Home Hub" class="w-full h-auto">
                        </div>
